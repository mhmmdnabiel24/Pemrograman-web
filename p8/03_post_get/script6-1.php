...
<form action="scripts1proses.php" method="post">
<table>
    <tr><td> Nama Anda</td><td>:</td><td><input type="text" name="nama" size="30""")/>></td></tr>
    <tr><td> Alamat</td><td>:</td><td><textarea name="alamat" rows="4" cols="28"></textarea></td></tr>
...
<tr><td>Status Menikah</td><td>:</td><td><input type="checkbox" name="status" value="Menikah"> Ya</td></tr>
</table>
